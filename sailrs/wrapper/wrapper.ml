...
let sail_dir =
  ...
  | None -> "/home/takana/.opam/default/share/sail"
...
let get_ast filepaths =
  ...
  Rewrites.opt_mono_rewrites := false;
...
let () =
  ...
  (* Primary functions *)
  Callback.register "get_ast" (fun filepaths ->
      exception_to_result (fun () -> get_ast filepaths));
